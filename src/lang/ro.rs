...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua NanoDesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca NanoDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala NanoDesk."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți NanoDesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți NanoDesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți NanoDesk să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [NanoDesk Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep NanoDesk background service", "Rulează serviciul NanoDesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației NanoDesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show NanoDesk", "Afișează NanoDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi NanoDesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi NanoDesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din NanoDesk care rulează."),
        ...
        ("verify_rustdesk_password_tip", "Verifică parola NanoDesk"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi NanoDesk pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_NanoDesk_server_pro_{}_tip", "Versiunea serverului NanoDesk Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul NanoDesk pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu NanoDesk"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web NanoDesk Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări NanoDesk. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About NanoDesk", "Despre NanoDesk"),
        ...
        ("web_id_input_tip", "Introdu ID-ul NanoDesk al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Versiunea clientului NanoDesk de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește NanoDesk Pro pentru funcționalitate completă."),
